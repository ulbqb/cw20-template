...
use cw20::{MarketingInfoResponse, EmbeddedLogo, Logo, LogoInfo};
use cw20_base::allowances::{
    execute_burn_from, execute_decrease_allowance, execute_increase_allowance, execute_send_from, execute_transfer_from, query_allowance
};
use cw20_base::ContractError;
use cw20_base::contract::{
    execute_burn, execute_mint, execute_send, execute_transfer, query_balance, query_token_info, create_accounts, execute_update_marketing, execute_upload_logo, execute_update_minter,
    query_minter, query_marketing_info, query_download_logo,
};
use cw20_base::enumerable::{query_owner_allowances, query_spender_allowances, query_all_accounts};
use cw20_base::state::{ MinterData, TokenInfo, ALLOWANCES, ALLOWANCES_SPENDER, LOGO, MARKETING_INFO, TOKEN_INFO,};
...
mod tests {
    ...
    use cosmwasm_std::{coins, from_json, Addr, CosmosMsg, StdError, SubMsg, WasmMsg, Uint128};
